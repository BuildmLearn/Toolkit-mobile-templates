...
/*
 * Original code from http://code.google.com/p/google-diff-match-patch/
 * has been modified by Anupam Das to handle the "word-mode" feature and its 'diff_prettyHtml'
...
public class diff_match_patch {
    ...
    public LinkedList<Diff> diff_WordMode(String text1, String text2) {
        LinesToCharsResult linesResult = diff_wordsToChars(text1, text2);
        String lineText1 = linesResult.chars1;
        String lineText2 = linesResult.chars2;
        LinkedList<Diff> diffs = diff_main(lineText1, lineText2, false);
        diff_charsToLines(diffs, linesResult.lineArray);
        return diffs;
    }
     ...
     * unique strings is intentionally blank.
     */
    protected LinesToCharsResult diff_wordsToChars(String text1, String text2) {
        List<String> lineArray = new ArrayList<String>();
        Map<String, Integer> lineHash = new HashMap<String, Integer>();
        // e.g. linearray[4] == "Hello\n"
        // e.g. linehash.get("Hello\n") == 4
     ...
     *
     * @param diffs LinkedList of Diff objects.
     * @return HTML representation. + number of equal words in an array
     * where first element is HTML representation and second
     * is number of Equal words.
     */
    public String[] diff_prettyHtml(LinkedList<Diff> diffs) {
        ...
        for (Diff aDiff : diffs) {
            ...
            switch (aDiff.operation) {
                case INSERT:
                    html.append("<font color=\"#7fe77f\">").append(text)
                            .append("</font>");
                    break;
                case DELETE:
                    html.append("<font color=\"#ee9797\">").append(text)
                            .append("</font>");
                    break;
                case EQUAL:
                    html.append("<span>").append(text).append("</span>");
                    numEqual += text.split(" ").length;
                    break;
            }
        }
        return new String[]{html.toString(), String.valueOf(numEqual)};
    }
